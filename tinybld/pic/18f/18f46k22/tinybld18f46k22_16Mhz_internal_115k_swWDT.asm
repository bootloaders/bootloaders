...
#define	EEPROMSIZE 1024   	; Size of EEPROM (256/1024), Please refer to the table below
	
xtal 	EQU 	16000000	; you may also want to change: _HS_OSC _XT_OSC
baud 	EQU 	115200 ;%19200		; standard TinyBld baud rates: 115200 or 19200
 ...
 #ENDIF
	...
	#include "spbrgselect.inc"	; RoundResult and baud_rate
		...
		#define first_address max_flash-200		;100 words
			...
			config P2BMX = PortD2		;P2B is on RB5
