...
movwf TBLPTRH
;
;<Edit Dan 2> transfer method of eeprom data has been changed.
...
movwf PREINC0
;
;<Edit Dan 3> transfer method of eeprom data has been changed.
;
movwf EEDATA
;
;<Edit Dan 3 end>
...
noeeprom
;
;<Edit Dan 4> This firmware is not compatible with the Config writing.
;
...
writebigloop 
;
;<Edit Dan 5>A write to program memory is executed on blocks of 64 bytes at a time.
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
