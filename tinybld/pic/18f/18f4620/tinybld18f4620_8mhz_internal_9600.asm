...
;	directory with your .asm source file), if necessary
	...
	#include "spbrgselect.inc"	; RoundResult and baud_rate
		...
		#define first_address max_flash-200		;100 words
;	__CONFIG _CONFIG1H, _OSC_HS_1H & _FCMEN_OFF_1H & _IESO_OFF_1H      ; hs
;	__CONFIG _CONFIG1H, _OSC_HSPLL_1H & _FCMEN_OFF_1H & _IESO_OFF_1H   ; hspll
	__CONFIG _CONFIG1H, _OSC_INTIO67_1H & _FCMEN_OFF_1H & _IESO_OFF_1H   ; internal no clock out??
